...
## v0.26.0 Knowledge Coverage Examples

The request and response schema is unchanged. `POST /support/preview` can now return more specific deterministic response drafts for common questions such as:

- `What wizard types are available?`
- `What are legendary wizards?`
- `What is resonance?`
- `How does fusion work?`
- `How do I place wizards on PC?`
- `I want a refund`

These responses are generated by rule-based topic detection and templates. No external LLM API is used.
